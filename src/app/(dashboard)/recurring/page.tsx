...
export default function RecurringPage() {
  ...
  const [formNextDate, setFormNextDate] = useState<string | undefined>(undefined);
  ...
  const getCategoryInfo = (type: string, category: string) => {
    ...
    return cats.find((c) => c.value === category) || { label: category, emoji: "📦" };
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(editId ? "Không thể cập nhật" : "Không thể tạo giao dịch định kỳ");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 pb-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Giao dịch định kỳ</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-sm border border-gray-100 dark:border-[#303030] p-5">
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Chi định kỳ / tháng</p>
          ...
          <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-sm border border-gray-100 dark:border-[#303030] p-5">
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Thu định kỳ / tháng</p>
          ...
          <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-sm border border-gray-100 dark:border-[#303030] p-5">
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Số dư định kỳ / tháng</p>
            <p className={`text-2xl font-bold mt-1 ${totalMonthlyIncome - totalMonthlyExpense >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 border-b border-gray-100 flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-900">Đang hoạt động</h2>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-500 mt-0.5">
                        ...
                        <span>
                          Tiếp theo: {format(new Date(item.nextDate), "dd/MM/yyyy", { locale: vi })}
                        </span>
                      </div>
                    </div>
        ...
        {inactiveItems.length > 0 && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-500">Đã tạm dừng</h2>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-400 mt-0.5">
                        {FREQUENCY_LABELS[item.frequency]} · {formatCurrency(Number(item.amount))}
                      </p>
                    </div>
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <button
